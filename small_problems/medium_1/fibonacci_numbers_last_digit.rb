...
# Output:
# - The last digit of the nth Fibonacci number of the given integer

# Rules:
# - It will be best to use the procedural method written in the previous exercise

# ALGORITHM:
# - Run fibonacci procedural method
#     - Convert integer into a string and return the last digit

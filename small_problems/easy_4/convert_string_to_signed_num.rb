...
# Output:
# - Given string as an Integer object (either negative or positive)
...
# - If first element is -, shift it into a variable
...
#   int_arr = string.chars.map { |char| NUMERIC_CHARS[char] }

#   result = 0
#   int_arr.inject { |int, i| result = int*10 + i}
  
#   sign == -1 ? result *= sign : result
